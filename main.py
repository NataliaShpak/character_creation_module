...
def defence(char_name: str, char_class: str) -> str:
    """Return string with blocked damage."""
    if char_class == 'warrior':
    ...
    return ('Защита не прокатила')


def special(char_name: str, char_class: str) -> str:
    """Return string with special skill."""
    if char_class == 'warrior':
        return (f'{char_name} '
    ...
    return ('Специальное умение не применилось')


def start_training(char_name: str, char_class: str) -> str:
    """Ask for command and print result while not stopped."""
    if char_class == 'warrior':
